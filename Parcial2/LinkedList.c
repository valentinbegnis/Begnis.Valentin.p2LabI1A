...
/** \brief Devuelve un nuevo LinkedList en el cual el campo duracion de cada elemento es cargado aleatoriamente
           por la funcion pFunc pasada por parametro
 * \param LinkedList* this a filtrar
 * \param int (*pFunc)(void*) Puntero a la funcion que recibe el elemento y calcula el tiempo
 * \return Nuevo puntero LinkedList con los elementos cargados aleatoriamente en sus campos duracion
 */
